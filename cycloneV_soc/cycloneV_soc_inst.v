	cycloneV_soc u0 (
		...
		.lwir_ul0304_datain              (<connected-to-lwir_ul0304_datain>),              //             lwir_ul0304.datain
		.lwir_ul0304_syt                 (<connected-to-lwir_ul0304_syt>),                 //                        .syt
		.lwir_ul0304_syl                 (<connected-to-lwir_ul0304_syl>),                 //                        .syl
		.lwir_ul0304_syp                 (<connected-to-lwir_ul0304_syp>),                 //                        .syp
		...
		.swir_v400_sensor_clk            (<connected-to-swir_v400_sensor_clk>),            //               swir_v400.sensor_clk
		.swir_v400_datain                (<connected-to-swir_v400_datain>),                //                        .datain
		.swir_v400_fsync                 (<connected-to-swir_v400_fsync>),                 //                        .fsync
		.swir_v400_lsync                 (<connected-to-swir_v400_lsync>),                 //                        .lsync
		.swir_v400_swir_pxl_clk_out      (<connected-to-swir_v400_swir_pxl_clk_out>)       //                        .swir_pxl_clk_out
	);
