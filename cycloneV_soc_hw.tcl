# _hw.tcl file for cycloneV_soc
package require -exact qsys 14.0

# module properties
set_module_property NAME {cycloneV_soc_export}
set_module_property DISPLAY_NAME {cycloneV_soc_export_display}
...
proc compose { } {
    ...
    set_instance_parameter_value hps_0 {F2SDRAM_Width} {32}
    ...
    add_instance led altera_avalon_pio 16.0
    ...
    add_instance sw altera_avalon_pio 16.0
    ...
    set_instance_parameter_value sw {width} {4}
    ...
    set_connection_parameter_value hps_0.h2f_lw_axi_master/led.s1 baseAddress {0x0040}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/led.s1 defaultConnection {0}

    add_connection hps_0.h2f_lw_axi_master sw.s1 avalon
    set_connection_parameter_value hps_0.h2f_lw_axi_master/sw.s1 arbitrationPriority {1}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/sw.s1 baseAddress {0x0030}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/sw.s1 defaultConnection {0}

    add_connection clk_0.clk sw.clk clock
    ...
    add_connection clk_0.clk_reset sw.reset reset
