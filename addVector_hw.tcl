...
add_interface_port slave_1 slave_address address Input 2
...
add_interface_port avalon_wr masterwr_burstcount burstcount Output nbits_burst
...
# 
# connection point avalon_rd1
# 
add_interface avalon_rd1 avalon start
set_interface_property avalon_rd1 addressUnits SYMBOLS
set_interface_property avalon_rd1 associatedClock clock
set_interface_property avalon_rd1 associatedReset reset_sink
set_interface_property avalon_rd1 bitsPerSymbol 8
set_interface_property avalon_rd1 burstOnBurstBoundariesOnly false
set_interface_property avalon_rd1 burstcountUnits WORDS
set_interface_property avalon_rd1 doStreamReads false
set_interface_property avalon_rd1 doStreamWrites false
set_interface_property avalon_rd1 holdTime 0
set_interface_property avalon_rd1 linewrapBursts false
set_interface_property avalon_rd1 maximumPendingReadTransactions 0
set_interface_property avalon_rd1 maximumPendingWriteTransactions 0
set_interface_property avalon_rd1 readLatency 0
set_interface_property avalon_rd1 readWaitTime 1
set_interface_property avalon_rd1 setupTime 0
set_interface_property avalon_rd1 timingUnits Cycles
set_interface_property avalon_rd1 writeWaitTime 0
set_interface_property avalon_rd1 ENABLED true
set_interface_property avalon_rd1 EXPORT_OF ""
set_interface_property avalon_rd1 PORT_NAME_MAP ""
set_interface_property avalon_rd1 CMSIS_SVD_VARIABLES ""
set_interface_property avalon_rd1 SVD_ADDRESS_GROUP ""

add_interface_port avalon_rd1 masterrd1_address address Output nbits_addr
add_interface_port avalon_rd1 masterrd1_read read Output 1
add_interface_port avalon_rd1 masterrd1_readdata readdata Input nbits_data
add_interface_port avalon_rd1 masterrd1_readdatavalid readdatavalid Input 1
add_interface_port avalon_rd1 masterrd1_waitrequest waitrequest Input 1
...
set_interface_property avalon_rd2 maximumPendingReadTransactions 0
...
add_interface_port avalon_rd2 masterrd2_address address Output 32
